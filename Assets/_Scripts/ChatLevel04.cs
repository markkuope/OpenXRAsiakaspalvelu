...
namespace OpenAI
{
    public class ChatLevel04 : MonoBehaviour
    {
        ...
        private void Start()
        {
            var message = new ChatMessage
            {
                ...
                Content =
                     "Speak finnish\n" +
                     "You, NPC, will act as a customer at a kitchen department of large department store.Your name is Helmi,  a friendly and outgoing retiree who is looking for a specific item she needs.\n" +
                     "If you,NPC, are satisfied with the quality and price of the item, end conversation and finish your sentence with the phrase END_CONVO \n" +
