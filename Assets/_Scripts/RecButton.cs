...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class RecButton : XRBaseInteractable
    {
        // otetaan OPenAI Text To Speech käyttöön tässä
        [SerializeField] private WhisperLevel01 whisperLevel01;
        ...
        public void StartPress(SelectEnterEventArgs args)
        {
            SetButtonHeight(-m_PressDistance);
            m_OnPress.Invoke();
            m_Selected = true;
            ...
            //tähän kohtaan äänityksen aloitus kutsu
            whisperLevel01.StartRecording();
        ...
        void EndPress(SelectExitEventArgs args)
        {
            ...
            //tähän kohtaan äänityksen lopetus
            whisperLevel01.StartRecording();
