...
namespace OpenAI
{
    public class ChatLevel01 : MonoBehaviour
    {
        ...
        private void Start()
        {
            var message = new ChatMessage
            {
                ...
                Content =
                    "Speak finnish\n" +
                     "You, ChatGPT, will act as a customer at a large department store.Your name is Helmi,  a friendly and outgoing retiree who is looking for the kitchen department.\n" +
                    "If the shop assistant tells you, ChatGPT,  were kitchen department is ,end conversation and finish your sentence with the phrase END_CONVO\n" +
